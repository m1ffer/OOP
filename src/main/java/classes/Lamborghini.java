...
public class Lamborghini extends GroundVehicle implements Animatable{
    private static final Image POLO_IMAGE = new Image("file:D:/lamborghini.png");
    ...
    private static final double STOP_ACCELERATION = -2;
    private static final double START_ACCELERATION = 3;
